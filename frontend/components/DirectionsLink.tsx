...
export default function DirectionsLink({
  ...
  const text = label ?? t(locale).place.directions;
...
function MapsMarker({ className }: { className: string }) {
  return (
    ...
    >
      ...
      />
      <path
        d="M12 3a7 7 0 0 0-6.1 3.6l8.4 7.2A28 28 0 0 0 19 10a7 7 0 0 0-7-7z"
        fill="#FBBC04"
      />
      <path
        d="M5.9 6.6A7 7 0 0 0 5 10c0 2 1.3 4.5 2.8 6.6l6.5-2.8-8.4-7.2z"
        fill="#34A853"
      />
