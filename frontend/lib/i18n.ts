...
const es = {
  ...
  account: {
    ...
    lead: "Para opinar sobre los lugares y guardar tus favoritos. Sin contraseñas.",
    google: "Continuar con Google",
    orEmail: "o con tu correo",
    name: "Tu nombre",
    nameHint: "Así firmarás tus opiniones.",
    email: "Tu correo",
    sendLink: "Enviarme el enlace",
    sending: "Enviando…",
    linkSentHeading: "Revisa tu correo",
    ...
    redeemButton: "Entrar",
    redeemMissing:
      "Este enlace no es válido. Pide uno nuevo con el botón «Entrar» de cualquier página.",
    errors: {
      name: "Escribe tu nombre.",
      email: "Escribe un correo válido.",
      failed: "No pudimos enviarte el enlace. Inténtalo más tarde.",
  ...
  reviews: {
    heading: "Opiniones",
    /** La etiqueta de cada valoración, siempre por separado: son dos públicos distintos. */
    siteLabel: "QueHacerRD",
    googleLabel: "Google",
    siteRating: "Valoración de los visitantes de QueHacerRD",
    count: (n: number): string => (n === 1 ? "1 opinión" : `${n} opiniones`),
    empty: "Todavía nadie ha opinado sobre este lugar. ¡Sé el primero!",
    signInToReview: "Entra para dejar tu opinión",
    write: "Deja tu opinión",
    yours: "Tu opinión",
    stars: "Tu valoración",
    star: (n: number): string => (n === 1 ? "1 estrella" : `${n} estrellas`),
    comment: "Cuéntanos cómo te fue",
    optional: "(opcional)",
    publicNote: "Se publica al momento, con tu nombre.",
    submit: "Publicar",
    update: "Guardar cambios",
    saving: "Guardando…",
    delete: "Borrar mi opinión",
    saved: "¡Gracias! Tu opinión ya está publicada.",
    deleted: "Borramos tu opinión.",
    hidden: "Un editor ocultó tu opinión: solo la ves tú.",
    edited: "editada",
    errors: {
      rating: "Elige de una a cinco estrellas.",
      signIn: "Vuelve a entrar para opinar.",
      failed: "No pudimos guardar tu opinión. Inténtalo más tarde.",
    },
  },
  favorites: {
    add: "Guardar",
    remove: "Guardado",
    addLabel: (name: string): string => `Guardar ${name} en mis favoritos`,
    removeLabel: (name: string): string => `Quitar ${name} de mis favoritos`,
    heading: "Mis favoritos",
    lead: "Los lugares que guardaste, en todas las ciudades.",
    empty:
      "Todavía no has guardado ningún lugar. Pulsa «Guardar» en la ficha de uno y aparecerá aquí.",
    signIn: "Entra para ver los lugares que guardaste.",
  },
  tours: {
...
const en: typeof es = {
  ...
  account: {
    signIn: "Sign in",
    heading: "Sign in to QueHacerRD",
    lead: "To review places and keep your favourites. No passwords.",
    google: "Continue with Google",
    orEmail: "or with your email",
    name: "Your name",
    nameHint: "How your reviews will be signed.",
    email: "Your email",
    ...
    redeemMissing:
      "This link is not valid. Ask for a new one with the “Sign in” button on any page.",
    errors: {
      name: "Write your name.",
      email: "Write a valid email address.",
      failed: "We could not send you the link. Please try again later.",
  ...
  reviews: {
    ...
    siteLabel: "QueHacerRD",
    googleLabel: "Google",
    siteRating: "Rating by QueHacerRD visitors",
    count: (n: number): string => (n === 1 ? "1 review" : `${n} reviews`),
    empty: "Nobody has reviewed this place yet. Be the first!",
    signInToReview: "Sign in to leave a review",
    write: "Leave a review",
    yours: "Your review",
    stars: "Your rating",
    star: (n: number): string => (n === 1 ? "1 star" : `${n} stars`),
    comment: "Tell us how it went",
    optional: "(optional)",
    publicNote: "It is published right away, with your name.",
    submit: "Publish",
    update: "Save changes",
    saving: "Saving…",
    ...
    hidden: "An editor hid your review: only you can see it.",
    edited: "edited",
    errors: {
      rating: "Choose from one to five stars.",
      signIn: "Sign in again to leave a review.",
      failed: "We could not save your review. Please try again later.",
    },
  },
  favorites: {
    add: "Save",
    remove: "Saved",
    addLabel: (name: string): string => `Save ${name} to my favourites`,
    removeLabel: (name: string): string => `Remove ${name} from my favourites`,
    heading: "My favourites",
    lead: "The places you saved, in every city.",
    empty:
      "You have not saved any place yet. Press “Save” on one and it will show up here.",
    signIn: "Sign in to see the places you saved.",
  },
  tours: {
    hour: "hour",
    hours: "hours",
